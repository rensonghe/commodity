...
class Ht_ai_strategy_demo_ag(CtaTemplate):
    ...
    side_long = 0.607719926135342
    side_short = 0.40804263389336687
    out = 0.7374073678308337  # 第二个模型阈值
    ...
    def __init__(self, name: str, code: str, expsecs: int, offset: int, signalfile: str = "", freq: int = 30):
        ...
        self.model_side_0 = joblib.load('{}/model/{}/{}_lightGBM_side_0.pkl'.format(self.base_path, 'AG', 'AG'))
        self.model_side_1 = joblib.load('{}/model/{}/{}_lightGBM_side_1.pkl'.format(self.base_path, 'AG', 'AG'))
        self.model_side_2 = joblib.load('{}/model/{}/{}_lightGBM_side_2.pkl'.format(self.base_path, 'AG', 'AG'))
        self.model_side_3 = joblib.load('{}/model/{}/{}_lightGBM_side_3.pkl'.format(self.base_path, 'AG', 'AG'))
        self.model_side_4 = joblib.load('{}/model/{}/{}_lightGBM_side_4.pkl'.format(self.base_path, 'AG', 'AG'))
        self.model_out_0 = joblib.load('{}/model/{}/{}_lightGBM_out_0.pkl'.format(self.base_path, 'AG', 'AG'))
        self.model_out_1 = joblib.load('{}/model/{}/{}_lightGBM_out_1.pkl'.format(self.base_path, 'AG', 'AG'))
        self.model_out_2 = joblib.load('{}/model/{}/{}_lightGBM_out_2.pkl'.format(self.base_path, 'AG', 'AG'))
        self.model_out_3 = joblib.load('{}/model/{}/{}_lightGBM_out_3.pkl'.format(self.base_path, 'AG', 'AG'))
        self.model_out_4 = joblib.load('{}/model/{}/{}_lightGBM_out_4.pkl'.format(self.base_path, 'AG', 'AG'))
                ...
                if factor['amount'].iloc[-1] - factor['amount'].iloc[-2] >= self.threshold:
                    ...
                    if y_pred_side_df['predict'].iloc[-1] >= self.side_long or y_pred_side_df['predict'].iloc[
                        ...
                        for key in ordict.keys():
                            limit_orders_values += float(ordict[key].price) * abs(float(ordict[key].leftQty)) * self.futuresize
                        # 持仓金额+挂单金额
                        final_values = limit_orders_values + self.get_position_avgpx(self.__code__) * abs(curPos) * self.futuresize
