...
def calc_ofi(depth, trade):
    a = depth['bid_size1']*np.where(depth['bid_price1'].diff()>=0,1,0)
    b = depth['bid_size1'].shift()*np.where(depth['bid_price1'].diff()<=0,1,0)
    c = depth['ask_size1']*np.where(depth['ask_price1'].diff()<=0,1,0)
    d = depth['ask_size1'].shift()*np.where(depth['ask_price1'].diff()>=0,1,0)
...
def weighted_price_to_mid(depth, trade, levels=1, alpha=1):
...
def QUA(depth, trade, rolling=120):
    single_trade_amount = (trade['price'])*(trade['size'])
...
def add_factor_process(depth, trade, futuresize=10, min=40):
    ...
    df['QUA'] = QUA(depth=None, trade=trade, rolling=120 * min)
    df['MTS'] = MTS(depth=None, trade=trade, rolling=120 * min)
    df['MTE'] = MTE(depth=None, trade=trade, rolling=120 * min)
    df['reverse_factor_w'] = reverse_factor_w(depth=None, trade=trade, rolling=120 * min)
    df['SR'] = SR(depth=None, trade=trade, rolling=120 * min)
    df['amount_std'] = amount_std(depth=None, trade=trade, rolling=120 * min)
    df['amount_skew'] = amount_skew(depth=None, trade=trade, rolling=120 * min)
    df['amount_kurt'] = amount_kurt(depth=None, trade=trade, rolling=120 * min)
